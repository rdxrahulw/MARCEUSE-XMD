 ...
 * Copyright (c) 2025 Nicolaus Daniel 😈
 * 
...
exports.tanggal = (numer) => {
    const myMonths = ["January", "February", "March", "April", "May", "Juni", "July", "August", "September", "October", "November", "Desember"];
    const myDays = ['Monday', 'Tuesday', 'W', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
