...
async function handleBadwordDetection(sock, chatId, message, userMessage, senderId) {
    ...
    const badWords = [
        ...
        'hash', 'trip', 'rolling', 'msenge', 'kuma', 'unatombwa', 'bitch', 'malaya',
        'choko', '🖕', 'kafirwe', 'mboo', 'ass', 'asshole', 'kuma la mama ako', 'mkundu', 'kinyeo', 'kubabako',
        
        'chokoraa', 'shoga', 'matako', 'k*ma', 'kum*', 'mseng*', 'choko', 'pumbu', 'mapumbu',
        
        'pumb*', 'mapumb*', 'fuck you', 'fu** you', 'son of bitch', 'unatiwa mboo', 'ududu', 'unaingiliwa'
    ];
